...
function XPerl_ArcaneBar_OnLoad(self)
	...
	self.barFlash.tex:SetTexture("Interface\\AddOns\\XPerl_CoA\\Images\\XPerl_ArcaneBarFlash")
	self.tex:SetTexture("Interface\\AddOns\\XPerl_CoA\\Images\\XPerl_StatusBar")
