...
-- Usage
XPerlUsageNameList	= {XPerl_CoA = "Core", XPerl_CoA_Player = "Player", XPerl_CoA_PlayerPet = "Pet", XPerl_CoA_Target = "Target", XPerl_CoA_TargetTarget = "Target's Target", XPerl_CoA_Party = "Party", XPerl_CoA_PartyPet = "Party Pets", XPerl_CoA_RaidFrames = "Raid Frames", XPerl_CoA_RaidHelper = "Raid Helper", XPerl_CoA_RaidAdmin = "Raid Admin", XPerl_TeamSpeak = "TS Monitor", XPerl_CoA_RaidMonitor = "Raid Monitor", XPerl_CoA_RaidPets = "Raid Pets", XPerl_CoA_ArcaneBar = "Arcane Bar", XPerl_CoA_PlayerBuffs = "Player Buffs", XPerl_GrimReaper = "Grim Reaper"}
...
XPERL_HIGHLIGHT_SPELLS = {
	hotSpells  = {
		...
		[GetSpellInfo(59542)] = 15,			-- Gift of the Naaru (Racial)
