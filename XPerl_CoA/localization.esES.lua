...
if (GetLocale() == "esES" or GetLocale() == "esMX") then
	...
	-- Usage
	XPerlUsageNameList	= {XPerl_CoA = "N\195\186cleo", XPerl_CoA_Player = "Jugador", XPerl_CoA_PlayerPet = "Mascota", XPerl_CoA_Target = "Objetivo", XPerl_CoA_TargetTarget = "Objetivo de Objetivo", XPerl_CoA_Party = "Grupo", XPerl_CoA_PartyPet = "Mascotas Grupo", XPerl_CoA_RaidFrames = "Marcos Banda", XPerl_CoA_RaidHelper = "Ayudante Banda", XPerl_CoA_RaidAdmin = "Admin Banda", XPerl_TeamSpeak = "Monitor TS", XPerl_CoA_RaidMonitor = "Monitor Banda", XPerl_CoA_RaidPets = "Mascotas Banda", XPerl_CoA_ArcaneBar = "Barra Arcana", XPerl_CoA_PlayerBuffs = "Buffs Jugador", XPerl_GrimReaper = "Grim Reaper"}
